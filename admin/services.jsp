...
<div class="st-container" data-ng-controller="adminLoginCtrl"
	data-ng-init="adminProfile('<%=z%>');getServicesData();">
				...
				<div class="container-fluid">
					<div class="profile-image">
						<div class="container">
							<div class="row">
								<div class="col-md-10">
									<div class="alert alert-success services-success">
										 Your <strong>services Successfully</strong> updated.
									</div>
									<div class="form-group">
										<form class="form-horizontal" name="form" enctype="application/x-www-form-urlencoded" >
											<div class="form-group">
												<textarea name="services" ng-model="services" id="services" ></textarea>
											</div>
											<div class="form-group">
												<input type="submit" id="servicesSettings" value="Update"
	...
	<!-- // Footer -->
	<script type="text/javascript">
		var data = CKEDITOR.replace('services');
		$(".services-success").hide();
		$("#servicesSettings").click(function(){
			var value = data.getData();
			$.ajax({
		           type: "POST",
		           url: 'webapi/admin/updateServices',
		           data: {services : value}, // serializes the form's elements.
		           encode : true,
		           success: function(data)
		           {
		        	   $(".services-success").show();
		           }
		         });
