...
<div class="st-container" data-ng-controller="adminLoginCtrl"
	data-ng-init="adminProfile('<%=z%>');getTermsData();">
				...
				<div class="container-fluid">
					<div class="profile-image">
						<div class="container">
							<div class="row">
								<div class="col-md-10">
									<div class="alert alert-success tc-success">
									...
									<div class="form-group">
										<form class="form-horizontal" name="form" enctype="application/x-www-form-urlencoded" >
											<div class="form-group">
												<textarea name="terms" ng-model="terms" id="terms" ></textarea>
											</div>
											<div class="form-group">
												<input type="submit" id="tc" value="Update"
	...
	<!-- // Footer -->
	<script type="text/javascript">
		var data = CKEDITOR.replace('terms');
		$(".tc-success").hide();
		$("#tc").click(function(){
			var value = data.getData();
			$.ajax({
		           type: "POST",
		           url: 'webapi/admin/updateTermsConditions',
		           data: {terms : value}, // serializes the form's elements.
		           encode : true,
