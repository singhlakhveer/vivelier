...
<div class="st-container" data-ng-controller="adminLoginCtrl"
	data-ng-init="adminProfile('<%=z%>');getPrivacyData();">
				...
				<div class="container-fluid">
					<div class="profile-image">
						<div class="container">
							<div class="row">
								<div class="col-md-10">
									<div class="alert alert-success privacy-success">
										 Privacy Policy <strong>Successfully</strong> updated.									</div>
									<div class="form-group">
										<form class="form-horizontal" name="form" enctype="application/x-www-form-urlencoded" >
											<div class="form-group">
												<textarea name="privacy" ng-model="privacy" id="privacy" ></textarea>
											</div>
											<div class="form-group">
												<input type="submit" id="privacyPolicy" value="Update"
	...
	<!-- // Footer -->
	<script type="text/javascript">
		var data = CKEDITOR.replace('privacy');
		$(".privacy-success").hide();
		$("#privacyPolicy").click(function(){
			var value = data.getData();
			$.ajax({
		           type: "POST",
		           url: 'webapi/admin/updatePrivacy',
		           data: {privacy : value}, // serializes the form's elements.
		           encode : true,
		           success: function(data)
		           {
		        	   $(".privacy-success").show();
		           }
		         });
