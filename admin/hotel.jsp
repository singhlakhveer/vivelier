		...
		<div class="st-content">
			...
			<div class="st-content-inner" id="content" data-scrollable>
				<div class="container-fluid">
					<button ui-sref="admin.hotels" class="btn btn-primary pull-right"
						style="margin-top: 9px; margin-right: 30px;"><%=prop.getProperty("hotelList")%></button>
					<h3><%=prop.getProperty("addNewHotel")%></h3>
					<br>
								...
								<div class="col-sm-8" ng-show="valid">
									<div class="alert alert-success">
										<a href="#" class="close" data-dismiss="alert"
											aria-label="close">&times;</a> <%=prop.getProperty("addHotelMsg")%>
									</div>
								</div>
							</div>
							<div class="row">
								<div class="col-sm-12">
									<form name="form" novalidate ng-submit="addHotel();">

										<div class="col-sm-12">
											<div class="form-group">
												<label class="col-sm-2 control-label"><%=prop.getProperty("hotelName")%> <span
													class="error">*</span></label>
												<div class="col-sm-6">
													<input type="hidden" class="form-control" name="id"
														ng-model="hotel.id">
													<!-- hotel id -->
													<input type="text" class="form-control" name="hotelName" autocomplete="off"
										...
										<div class="col-sm-12">
											<div class="form-group">
												<br> <label class="col-sm-2 control-label"><%=prop.getProperty("address")%>
										...
										<div class="col-sm-12">
											<div class="form-group">
												<br> <label class="col-sm-2 control-label"><%=prop.getProperty("city")%>
													<span class="error">*</span>
												</label>
												<div class="col-sm-6">
										...
										<div class="col-sm-12">
											<div class="form-group">
												<br> <label class="col-sm-2 control-label"><%=prop.getProperty("state")%>
													<span class="error">*</span>
												</label>
												<div class="col-sm-6">
										...
										<div class="col-sm-12">
											<div class="form-group">
												<br> <label class="col-sm-2 control-label"><%=prop.getProperty("country")%>
													<span class="error">*</span>
												</label>
												<div class="col-sm-6">
										...
										<div class="col-sm-12">
											<div class="form-group">
												<br> <label class="col-sm-2 control-label"><%=prop.getProperty("zip")%>
													<span class="error">*</span>
												</label>
												<div class="col-sm-6">
													<input type="text" class="form-control" name="zip" maxlength="6" autocomplete="off"
										...
										<div class="col-sm-12">
											<div class="form-group">
												<br> <label class="col-sm-2 control-label"><%=prop.getProperty("hotelRating")%>
													<span class="error">*</span>
												</label>
												<div class="col-sm-6">
													<input type="text" class="form-control" name="rating" maxlength="3" autocomplete="off"
														ng-model="hotel.rating" required="required" placeholder="4.5 out of 5 "> <span
														ng-show="form.rating.$touched && form.rating.$error.required"
														style="color: #ca0707;"><%=prop.getProperty("validHotelRating")%></span>
												</div>
											</div>
										</div>
										<div class="col-sm-12">
											<div class="form-group">
												<br> <label class="col-sm-2 control-label"><%=prop.getProperty("website")%>
													<span class="error">*</span>
												</label>
												<div class="col-sm-6">
													<input type="text" class="form-control" name="website" autocomplete="off"
														...
														style="color: #ca0707;"><%=prop.getProperty("validWebsite")%></span>
												</div>
											</div>
										</div>
										<div class="col-sm-12">
											<div class="form-group">
												<br> <label class="col-sm-2 control-label"><%=prop.getProperty("email")%>
													<span class="error">*</span>
												</label>
												<div class="col-sm-6">
													<input type="email" class="form-control" name="email1" autocomplete="off"
										...
										<div class="col-sm-12">
											<div class="form-group">
												...
												<div class="col-sm-6">
													<input type="email" class="form-control" name="email2" autocomplete="off"
														ng-model="hotel.email2">
												</div>
											</div>
										</div>
										<div class="col-sm-12">
											<div class="form-group">
												<br> <label class="col-sm-2 control-label"><%=prop.getProperty("phone")%>
													<span class="error">*</span>
												</label>
												<div class="col-sm-6">
													<input type="text" class="form-control" name="telephone1" autocomplete="off"
										...
										<div class="col-sm-12">
											<div class="form-group">
												...
												<div class="col-sm-6">
													<input type="text" class="form-control" name="telephone2" autocomplete="off"
														ng-model="hotel.telephone2">
												</div>
											</div>
										</div>
										<div class="col-sm-12">
											<div class="form-group">
												<br> <label class="col-sm-2 control-label"><%=prop.getProperty("remarks")%>
													<span class="error">*</span>
												</label>
												<div class="col-sm-6">
											...
											<div class="form-group">
												...
												<div class="col-sm-6">
													<input type="Submit" class="btn btn-primary"
														value="<%=prop.getProperty("addNewHotel")%>" ng-disabled="!form.$valid">
												</div>
											</div>
										</div>
									</form>
