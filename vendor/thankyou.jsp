...
%>
<%
	String vmail = (String) request.getSession().getAttribute("thanksEmail");
	String vplan = (String) request.getSession().getAttribute("thanksPlan");
%>
<div class="st-container" data-ng-controller="vendorCtrl"
	data-ng-init="vendorProfile('<%=z%>'); thanksUpdatePlan('<%=vmail%>','<%=vplan%>');">
	<!-- Fixed navbar -->
			...
			<div class="st-content-inner" id="content" data-scrollable
				...
				<div class="container-fluid">
					<div class="page-section" style="height: 330px;">
						<h1 style="text-align: center;"><%=prop.getProperty("thanksForUpdatePlan")%></h1>
					</div>
				</div>
			</div>
		</div>
